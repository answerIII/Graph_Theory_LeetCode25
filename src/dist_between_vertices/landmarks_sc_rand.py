...
def processFile(file_path: str) -> None:
    ...
    for landmarks_num in total_landmarks_lst:
        ...
        landmarks_lst = chooseRandomNodes(lwc_undir_adj_list, landmarks_num)
        ...
        for _ in range(TOTAL_DIST_COMPUTES):
            ...
            rand_lm_sc_start_time = time()
            rand_dist_sum += landmarksSC(
                lwc_undir_adj_list,
                spt_lst,
                landmarks_lst,
                landmarks_num,
            ...
            rand_lm_sc_time += time() - rand_lm_sc_start_time
        ...
        print(
            ...
            f"rand nodes: {rand_lm_sc_time} sec"
        )
        print(f"\t\tTotal: {time() - total_start_time} sec")
        print("\tAccuracy")
        print(
            "\t\tLandmarks-SC random landmarks: "
